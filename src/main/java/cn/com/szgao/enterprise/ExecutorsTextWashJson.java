 ...
 *
 */
public class ExecutorsTextWashJson {
...
//			}
	...
	public static void main(String[] args) throws InterruptedException {
		...
		try {
			FileIntoDataBase2p5WashJson ff = new FileIntoDataBase2p5WashJson();
			
//			ff.show(new File("D:/工商数据已去重/160617后补数据/工商-广东-0001.txt"), 0);
//			ff.show(new File("D:/工商数据已去重/160530与小数据企业名对比等数据/工商-Json-0001/工商-Json-0001.txt"), 0);//------------------------liu 14
			
//			ff.show(new File("D:/工商数据已去重/160617后补数据"), 0);//------------------------liu 14
//			ff.show(new File("D:/工商数据已去重/160617后补数据/工商-special-0001.txt"), 0);
//			ff.show(new File("D:/工商数据已去重/江苏省/工商-江苏省-0026.txt"), 38510);
//			ff.show(new File("D:/工商数据已去重/160530与小数据企业名对比等数据/工商-小数据2-0001.txt"), 2217);//------------------------liu 14
			
//			ff.show(new File("D:/工商数据已去重/辽宁省/工商-辽宁省-0002.txt"), 47038);
			
//			ff.show(new File("E:/工商数据已去重/北京市180000.json"), 0);//数量:34431文件： E:\工商数据已去重\北京市180000.json
			
//			ff.show(new File("D:/工商数据已去重/北京市/工商-北京市-0023.txt"),40541);
			
//			ff.show(new File("D:\\工商数据已去重\\160407工商"),0);
			
			
			ff.show(new File("D:/工商数据已去重/rinsecom_new/1pi"), 4559);
			
//			ff.show(new File("D:/工商数据已去重/吉林省"), 0);//------------------------liu 14
//			ff.show(new File("D:/工商数据已去重/宁夏"), 0);
//			ff.show(new File("D:/工商数据已去重/青海省"), 0);
//			ff.show(new File("D:/工商数据已去重/西藏"), 0);
//			ff.show(new File("D:/工商数据已去重/总局"), 0);
			
//			ff.show(new File("D:/工商数据已去重/160407工商"), 0);
//			ff.show(new File("D:/工商数据已去重/160530与小数据企业名对比等数据"), 0);
//			ff.show(new File("D:/工商数据已去重/160617后补数据"), 0);
			

//			ff.show(new File("D:/工商数据已去重/甘肃省"), 0);
//			ff.show(new File("D:/工商数据已去重/广西"), 0);
//			ff.show(new File("D:/工商数据已去重/广州市"), 0);
//			ff.show(new File("D:/工商数据已去重/安徽省"), 0);
//			ff.show(new File("D:/工商数据已去重/北京市"), 0);
//			ff.show(new File("D:/工商数据已去重/福建省"), 0);
//			ff.show(new File("D:/工商数据已去重/广东省"), 0);
//			ff.show(new File("D:/工商数据已去重/深圳市"), 0);
//			
//			ff.show(new File("D:/工商数据已去重/山西省"), 0);// ------------ hui 10
//			ff.show(new File("D:/工商数据已去重/陕西省"), 0);
//			ff.show(new File("D:/工商数据已去重/新疆"), 0);
//			ff.show(new File("D:/工商数据已去重/云南省"), 0);
//			ff.show(new File("D:/工商数据已去重/山东省"), 0);
//			ff.show(new File("D:/工商数据已去重/上海市"), 0);
//			ff.show(new File("D:/工商数据已去重/四川省"), 0);
//			ff.show(new File("D:/工商数据已去重/重庆市"), 0);
//			ff.show(new File("D:/工商数据已去重/天津市"), 0);
//			ff.show(new File("D:/工商数据已去重/浙江省"), 0);
//			
//			 ff.show(new File("D:/工商数据已去重/内蒙古"), 0);//------------------- changyi 11
//			 ff.show(new File("D:/工商数据已去重/贵州省"), 0);
//			 ff.show(new File("D:/工商数据已去重/海南省"), 0);
//			 ff.show(new File("D:/工商数据已去重/黑龙江省"), 0);
//			 ff.show(new File("D:/工商数据已去重/湖北省"), 0);
//			 ff.show(new File("D:/工商数据已去重/江西省"), 0);
//			 ff.show(new File("D:/工商数据已去重/湖南省"), 0);
//			 ff.show(new File("D:/工商数据已去重/辽宁省"), 0);
//			 ff.show(new File("D:/工商数据已去重/江苏省"), 0);
//			 ff.show(new File("D:/工商数据已去重/河北省"), 0);
//			 ff.show(new File("D:/工商数据已去重/河南省"), 0);
