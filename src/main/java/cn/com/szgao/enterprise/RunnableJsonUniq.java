...
public class RunnableJsonUniq implements Runnable{
	
	private static Logger log = LogManager.getLogger(RunnableJsonUniq.class);
	static {
	...
	private File file;
	private FileIntoDataBaseToUniq fileIntoDataBase2;
	private int startNum;
	public RunnableJsonUniq(File file,int startNum,FileIntoDataBaseToUniq fileIntoDataBase2){
		this.file=file;
		this.fileIntoDataBase2=fileIntoDataBase2;
	}
	public RunnableJsonUniq(){}
	public void run() {
//		Logger log=ThreadLoggerFactory.getLogger();
		try {
			long da=System.currentTimeMillis();
			fileIntoDataBase2=new FileIntoDataBaseToUniq();
