...
public class RunnableJsonJion implements Runnable{
	
	
	private static Logger log = LogManager.getLogger(RunnableJsonJion.class);
	static {
	...
	private File file;
	private FileIntoDataBaseToJion fileIntoDataBase2;
	private int startNum;
	public RunnableJsonJion(File file,int startNum,FileIntoDataBaseToJion fileIntoDataBase2){
		this.file=file;
		this.fileIntoDataBase2=fileIntoDataBase2;
	}
	public RunnableJsonJion(){}
	public void run() {
//		Logger log=ThreadLoggerFactory.getLogger();
		try {
			long da=System.currentTimeMillis();
			fileIntoDataBase2=new FileIntoDataBaseToJion();
