...
public class RunnableJsonHeBin implements Runnable{
	
	private static Logger log = LogManager.getLogger(RunnableJsonHeBin.class);
	static {
	...
	private File file;
	private FileIntoDataBaseToHeBin fileIntoDataBase2;
	private int startNum;
	public RunnableJsonHeBin(File file,int startNum,FileIntoDataBaseToHeBin fileIntoDataBase2){
		this.file=file;
		this.fileIntoDataBase2=fileIntoDataBase2;
	}
	public RunnableJsonHeBin(){}
	public void run() {
//		Logger log=ThreadLoggerFactory.getLogger();
		try {
			long da=System.currentTimeMillis();
			fileIntoDataBase2=new FileIntoDataBaseToHeBin();
