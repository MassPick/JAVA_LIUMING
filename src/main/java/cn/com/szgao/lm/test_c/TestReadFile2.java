...
public class TestReadFile2 {
	...
	// 日志对象
	private static Logger log = LogManager.getLogger(TestReadFile2.class);
...
//		String filepath = "D:\\temp\\通过法院名查询的裁判文书";
		String filepath = "C:\\湖北";
//		 String filepath = "E:\\temp\\上海市\\No文档\\上海法院法律文书检索中心\\上海法院法律文书检索中心\\上海法院法院文书检索中心-刑事";
	...
	public static void readfile(String filepath) throws SQLException {
		String sqlInsert = "INSERT INTO court2_t(court_name,province,city,area,court_name2,create_by,modify_date)VALUES(?,?,?,?,?,'lm1225',LOCALTIMESTAMP)";
...
//			System.out.println(file.getName());
			...
			long endTime = System.currentTimeMillis();
			System.out.println(
					"遍历文件 Speed : " + (float) (filelist.length / ((float) ((float) ((endTime - startTime) / 1000) / 60) / 60)) + "个/小时");
