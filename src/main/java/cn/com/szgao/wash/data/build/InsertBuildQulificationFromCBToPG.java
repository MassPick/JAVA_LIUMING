...
public class InsertBuildQulificationFromCBToPG {
	...
	static int i = 0;
	private static Logger log = LogManager.getLogger(InsertBuildQulificationFromCBToPG.class);
	static Bucket bucket = null;

	static Connection conn = null;
	static PreparedStatement stmtInsert = null;
	// 19个
	static String sqlInsert = "INSERT INTO build_qulification_t_n(build_base_id,company_name,qualification_item ,certificateno,expire_date,certificate_date,collect_time )"
			+ "VALUES(?::uuid,    ?,?,?,?,?,? )";
