 ...
 */
public class Get2suitType2 {
	/**
	 * 写日志
	 */
	private static Logger logger = LogManager.getLogger(Get2suitType2.class.getName());
	private static Logger log = LogManager.getLogger(Get2suitType2.class.getName());
...
//						if(StringUtils.isNull(archHtml.getCaseBrief())){
						...
						vv.setCaseNum3(archJson.getCaseNum());//再审的案号
						vv.setCaseNum2(archHtml.getCaseNum1());//二审的案号
