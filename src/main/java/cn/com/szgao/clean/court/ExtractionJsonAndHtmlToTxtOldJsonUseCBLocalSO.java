...
/**
 * 以html为准，利用CB进行数据清洗    地方法院html  E:\法院详细页面\地方       除标1 标2的其他地方html
 * 
 * @author liuming
 * @Date 2016年6月16日 下午2:32:12
 */
public class ExtractionJsonAndHtmlToTxtOldJsonUseCBLocalSO {
	/**
	 * 写日志
	 */
	private static Logger logger = LogManager.getLogger(ExtractionJsonAndHtmlToTxtOldJsonUseCBLocalSO.class.getName());
	private static Logger log = LogManager.getLogger(ExtractionJsonAndHtmlToTxtOldJsonUseCBLocalSO.class.getName());
	...
	public static void main(String[] args) throws Exception {
		...
		File file = new File("E:/法院详细页面/地方/杜集区人民法院_乱/5a4ab8e9-a96b-50f1-8d57-e852fc96249b.html");
...
//			while ((temp = reader.readLine()) != null) {
				...
				if (countNum % 10000 == 0) {
					countP++;
					String folderPathUn = "D:\\法院详细页面(清洗)\\地方";
					String filePathUn = "D:\\法院详细页面(清洗)\\地方\\" + (countP)+"_"+DateUtils.getDateyyyyMMddhhmmss()  + "地方其他.json";
				...
				try {
					...
					archHtml = ExtractionHtmlOldLocalSO.getVoFromHtml(file);
					...
					e.printStackTrace();
					// 合并vo
					finalVo = heBinVo(archJson, archHtml, 83);
					if(finalVo!=null){
