...
/**
 * 以html为准，利用CB进行数据清洗    地方法院html  E:\法院详细页面\地方   标准1  晓慧电脑  D:/法院详细页面/地方/标1     没有利用CB，因为CB中法院名对应的文件可能不一样
 * 
 * @author liuming
 * @Date 2016年6月16日 下午2:32:12
 */
public class ExtractionJsonAndHtmlToTxtOldJsonUseCBLocalS1 {
	/**
	 * 写日志
	 */
	private static Logger logger = LogManager.getLogger(ExtractionJsonAndHtmlToTxtOldJsonUseCBLocalS1.class.getName());
	private static Logger log = LogManager.getLogger(ExtractionJsonAndHtmlToTxtOldJsonUseCBLocalS1.class.getName());
...
//		File file = new File("E:/法院详细页面/地方/标1");
//		File file = new File("E:/法院详细页面/地方/标1/榆林市神木县人民法院/022fa5f9-62e9-5e5c-b354-e94421e4cb44.html");
		File file = new File("E:/法院详细页面/地方/标1/榆林市神木县人民法院");
...
//			while ((temp = reader.readLine()) != null) {
				...
				if (countNum % 10000 == 0) {
					countP++;
					String folderPathUn = "D:\\法院详细页面(清洗)\\地方\\标1";
					String filePathUn = "D:\\法院详细页面(清洗)\\地方\\标1\\" + (countP)+"_"+DateUtils.getDateyyyyMMddhhmmss()  + "地方标1.json";
...
//					archHtml = ExtractionHtmlOld.getVoFromHtml(file);
					archHtml = ExtractionHtmlOldLocalS1.getVoFromHtml(file);
					...
					e.printStackTrace();
					// 合并vo
					finalVo = heBinVo(archJson, archHtml, 81);
					if(finalVo!=null){
