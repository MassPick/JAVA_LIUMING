 ...
 * 处理地方doc的内容
 * @author liuming
 * @Date 2016年7月8日 上午11:19:15
 */
public class ExtractionJsonAndHtmlToTxtOldJsonUseCBLocalSDoc {
	/**
	 * 写日志
	 */
	private static Logger logger = LogManager.getLogger(ExtractionJsonAndHtmlToTxtOldJsonUseCBLocalSDoc.class.getName());
	private static Logger log = LogManager.getLogger(ExtractionJsonAndHtmlToTxtOldJsonUseCBLocalSDoc.class.getName());
...
//		File file = new File("E:/法院详细页面/地方/doc_乱/123480b1-9a32-5c03-80ac-91595cfe418e.doc");
//		File file = new File("E:/法院详细页面/地方/doc_乱/1a7e4608-6eea-5ab3-8437-44bf9b5b6796.doc");
		
		File file = new File("E:/法院详细页面/地方/doc_1");
...
//			while ((temp = reader.readLine()) != null) {
				...
				if (countNum % 10000 == 0) {
					countP++;
					String folderPathUn = "D:\\法院详细页面(清洗)\\地方\\doc";
					String filePathUn = "D:\\法院详细页面(清洗)\\地方\\doc\\" + (countP)+"_"+DateUtils.getDateyyyyMMddhhmmss()  + "地方doc.json";
				...
				try {
					...
					archHtml = ExtractionHtmlOldLocalSDoc.getVoFromDoc(file);
					...
					e.printStackTrace();
					// 合并vo
					finalVo = heBinVo(archJson, archHtml, 85);
					if(finalVo!=null){
