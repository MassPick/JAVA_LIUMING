...
/**
 * 以html为准，利用CB进行数据清洗   E:\法院详细页面\中国裁判文书网展示文书详细页面（旧版高院）
 * 
 * @author liuming
 * @Date 2016年6月16日 下午2:32:12
 */
public class ExtractionJsonAndHtmlToTxtOldJsonUseCB {
	/**
	 * 写日志
	 */
	private static Logger logger = LogManager.getLogger(ExtractionJsonAndHtmlToTxtOldJsonUseCB.class.getName());
	private static Logger log = LogManager.getLogger(ExtractionJsonAndHtmlToTxtOldJsonUseCB.class.getName());
...
//		File file = new File("E:\\法院详细页面\\中国裁判文书网展示文书详细页面（旧版高院）\\zgcpwsw-20150831\\zgcpwsw-20150831\\source\\上海\\上海市嘉定区人民法院\\eddb0c9c-77d2-58db-a3f8-1267aacb53c9.html");
//		File file = new File("E:\\法院详细页面\\中国裁判文书网展示文书详细页面（旧版高院）\\zgcpwsw201503\\cpwsw\\ms\\0006352d-59a4-5ec4-b3fa-a02f1ad23d88.html");
//		File file = new File("E:\\法院详细页面\\中国裁判文书网展示文书详细页面（旧版高院）\\zgcpwsw201503\\cpwsw\\ms\\000adfe7-a864-5822-9a49-ce26b0433ddc.html");
		
		
		
		File file = new File("E:\\法院详细页面\\中国裁判文书网展示文书详细页面（旧版高院）\\zgcpwsw201503");
		File file2 = new File("E:\\法院详细页面\\中国裁判文书网展示文书详细页面（旧版高院）\\zgcpwsw201505");
		File file3 = new File("E:\\法院详细页面\\中国裁判文书网展示文书详细页面（旧版高院）\\zgcpwsw201506");
		File file4 = new File("E:\\法院详细页面\\中国裁判文书网展示文书详细页面（旧版高院）\\zgcpwsw201507");
		
		File file5 = new File("E:\\法院详细页面\\中国裁判文书网展示文书详细页面（旧版高院）\\zgcpwsw20150724");
		File file6 = new File("E:\\法院详细页面\\中国裁判文书网展示文书详细页面（旧版高院）\\zgcpwsw20150812");
		
		File file7 = new File("E:\\法院详细页面\\中国裁判文书网展示文书详细页面（旧版高院）\\zgcpwsw-20150831");
		File file8 = new File("E:\\法院详细页面\\中国裁判文书网展示文书详细页面（旧版高院）\\zgcpwsw-20151102");
		File file9 = new File("E:\\法院详细页面\\中国裁判文书网展示文书详细页面（旧版高院）\\zgcpwsw-20151127");
...
//			while ((temp = reader.readLine()) != null) {
				...
				if (countNum % 10000 == 0) {
					countP++;
					String folderPathUn = "D:\\法院详细页面(清洗)\\中国裁判文书网展示文书详细页面（旧版高院）_161107";
					String filePathUn = "D:\\法院详细页面(清洗)\\中国裁判文书网展示文书详细页面（旧版高院）_161107\\" + (countP)+"_"+DateUtils.getDateyyyyMMddhhmmss()  + "_中国裁判文书网展示文书详细页面（旧版高院）_161107.json";
				...
				try {
					...
					archHtml.setFilePathHtml(fileHtmlpath);
					...
					// 合并vo
					finalVo = heBinVo(archJson, archHtml, 6);
					if(finalVo!=null){
						finalVo.setFilePath(fileHtmlpath);
...
//			}
	...
	public static WholeCourtVO heBinVo(WholeCourtVO archJson1, WholeCourtVO archHtml, Integer dataFrom) {
		...
		if(archJson1==null&&archHtml==null){
			return null;
		}
		String[] array = null;
...
//		if (null != archJson) {
			...
			if (null != archHtml) {
				...
				if (StringUtils.isNull(archJson.getCourtName())&&StringUtils.isNull(archJson.getProvince()) ) {//法院
