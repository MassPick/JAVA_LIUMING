 ...
 */
public class InseartCourtToBlob {
...
//			+ "EndpointSuffix=core.chinacloudapi.cn";
	 ...
	 * 写日志
	 */
	private static Logger logger = LogManager.getLogger(InseartCourtToBlob.class.getName());
	private static Logger log = LogManager.getLogger(InseartCourtToBlob.class.getName());
	...
	public static void main(String[] args) throws Exception {
		...
		File file = new File("D:/data/wenhao/ffdff0ca-7716-5240-a266-b73bfe8cc8de.html");
...
//		Bucket bucket = null;
		...
		try {
			...
			CloudBlobContainer container = blobClient.getContainerReference("courts");
