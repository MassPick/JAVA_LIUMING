...
/**
 * 以html为准，利用CB进行数据清洗    地方法院html  E:\法院详细页面\地方   标准2
 * 
 * @author liuming
 * @Date 2016年6月16日 下午2:32:12
 */
public class ExtractionJsonAndHtmlToTxtOldJsonUseCBLocalS2 {
	/**
	 * 写日志
	 */
	private static Logger logger = LogManager.getLogger(ExtractionJsonAndHtmlToTxtOldJsonUseCBLocalS2.class.getName());
	private static Logger log = LogManager.getLogger(ExtractionJsonAndHtmlToTxtOldJsonUseCBLocalS2.class.getName());
...
//		File file = new File("E:/法院详细页面/地方/福州市长乐市人民法院_标2_上内容/0d053de8-1ade-592c-ab90-c4a7d2270c76.html");
//		File file = new File("E:/法院详细页面/地方/3a8bb1a9-7837-5543-8585-752bdacb0b4f.html");
		File file = new File("E:/法院详细页面/地方/标2");
...
//			while ((temp = reader.readLine()) != null) {
				...
				if (countNum % 10000 == 0) {
					countP++;
					String folderPathUn = "D:\\法院详细页面(清洗)\\地方\\标2";
					String filePathUn = "D:\\法院详细页面(清洗)\\地方\\标2\\" + (countP)+"_"+DateUtils.getDateyyyyMMddhhmmss()  + "地方标2.json";
...
//					archHtml = ExtractionHtmlOld.getVoFromHtml(file);
					archHtml = ExtractionHtmlOldLocalS2.getVoFromHtml(file);
					...
					e.printStackTrace();
					// 合并vo
					finalVo = heBinVo(archJson, archHtml, 82);
					if(finalVo!=null){
