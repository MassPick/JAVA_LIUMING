 ...
 */
public class ExecutorsWashCourtJsonToJson_laws {
	...
	// 日志对象
	public static final Logger log = LogManager.getLogger(ExecutorsWashCourtJsonToJson_laws.class);
	...
	public static void main(String[] args) throws InterruptedException {
		...
		try {
			WashCourtJsonToJson_laws ff = new WashCourtJsonToJson_laws();
			ff.show(new File("D:\\lm\\log\\法院详细页面(清洗)"), 0);
			log.info("-----完");
		} catch (IOException e) {
			e.printStackTrace();
